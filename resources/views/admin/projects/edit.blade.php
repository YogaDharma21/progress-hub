                ...
                <div class="space-y-1.5">
                    ...
                    <div class="flex items-center gap-4 p-4 bg-zinc-950 border border-zinc-800 rounded-xl">
                        ...
                        <div class="flex-1 space-y-1">
                            <p class="text-xs font-medium text-zinc-200">evoting-showcase-banner.png</p>
                            <p class="text-[11px] text-zinc-500">1280x720 • 1.2 MB</p>
                            <label for="project-image" class="inline-block mt-1 px-3.5 py-1.5 text-xs font-medium text-zinc-200 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 rounded-lg cursor-pointer transition">
                                Ganti Gambar Banner
                            </label>
                ...
                <div class="space-y-2 pt-2">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div class="space-y-1.5">
                            ...
                            <input id="link-demo" type="url" value="https://evoting-demo.example.com" placeholder="https://demo.example.com" 
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input id="link-github" type="url" value="https://github.com/ukm/evoting-kampus" placeholder="https://github.com/user/repo" 
                                class="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-3.5 py-2.5 text-xs text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-400 transition" />
                        </div>
                        <div class="space-y-1.5">
                            <span class="block text-[11px] font-medium text-zinc-400">Documentation</span>
                            <input id="link-docs" type="url" value="https://docs.evoting-kampus.example.com" placeholder="https://docs.example.com" 
                                class="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-3.5 py-2.5 text-xs text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-400 transition" />
                        </div>
                    </div>
                </div>
            ...
            <div id="features-container" class="mt-5 grid grid-cols-1 md:grid-cols-2 gap-5">
                <div class="feature-item bg-zinc-950 border border-zinc-800 rounded-xl p-5 space-y-4 relative group hover:border-zinc-700 transition shadow-sm">
                    ...
                    <div class="space-y-3">
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="features[0][title]" value="Verifikasi Identitas" placeholder="Nama Fitur" 
                        ...
                        <div class="space-y-1.5">
                            ...
                            <textarea name="features[0][description]" rows="3" placeholder="Deskripsi ringkas keunggulan fitur..." 
                                class="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-3.5 py-2.5 text-xs text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-400 transition leading-relaxed">Sistem verifikasi mahasiswa dengan data akademik terintegrasi</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="feature-item bg-zinc-950 border border-zinc-800 rounded-xl p-5 space-y-4 relative group hover:border-zinc-700 transition shadow-sm">
                    ...
                    <div class="space-y-3">
                        <div class="space-y-1.5">
                            <label class="block text-[11px] font-medium text-zinc-400">Nama Fitur</label>
                            <input type="text" name="features[1][title]" value="Voting Terenkripsi" placeholder="Nama Fitur" 
                                class="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-3.5 py-2.5 text-xs text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-400 transition font-medium" />
                        </div>
                        <div class="space-y-1.5">
                            <label class="block text-[11px] font-medium text-zinc-400">Deskripsi Fitur</label>
                            <textarea name="features[1][description]" rows="3" placeholder="Deskripsi ringkas keunggulan fitur..." 
                                class="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-3.5 py-2.5 text-xs text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-400 transition leading-relaxed">Pemungutan suara dengan enkripsi end-to-end untuk integritas data</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="feature-item bg-zinc-950 border border-zinc-800 rounded-xl p-5 space-y-4 relative group hover:border-zinc-700 transition shadow-sm">
                    ...
                    <div class="space-y-3">
                        <div class="space-y-1.5">
                            <label class="block text-[11px] font-medium text-zinc-400">Nama Fitur</label>
                            <input type="text" name="features[2][title]" value="Hasil Real-time" placeholder="Nama Fitur" 
                                class="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-3.5 py-2.5 text-xs text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-400 transition font-medium" />
                        </div>
                        <div class="space-y-1.5">
                            <label class="block text-[11px] font-medium text-zinc-400">Deskripsi Fitur</label>
                            <textarea name="features[2][description]" rows="3" placeholder="Deskripsi ringkas keunggulan fitur..." 
                                class="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-3.5 py-2.5 text-xs text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-400 transition leading-relaxed">Monitor perolehan suara secara langsung dengan dashboard statistik</textarea>
                        </div>
                    </div>
                </div>
            </div>
