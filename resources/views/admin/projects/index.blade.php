                    ...
                    @forelse ($projects as $project)
                        <tr class="hover:bg-zinc-800/40 transition">
                            ...
                            <td class="px-5 py-4 text-right space-x-2">
                                <a href="{{ route('admin.projects.edit', $project) }}" class="px-3 py-1.5 text-xs font-medium text-zinc-200 bg-zinc-800 border border-zinc-700 rounded-md hover:bg-zinc-700 transition">Edit</a>
