        ...
        <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-sm">
            ...
            <div class="mt-5 space-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <label for="image" class="relative flex flex-col items-center justify-center w-full min-h-[190px] py-9 px-6 border-2 border-dashed border-zinc-800 hover:border-zinc-700 bg-zinc-950 rounded-xl cursor-pointer transition overflow-hidden group">
                        <div id="image-placeholder" class="flex flex-col items-center justify-center text-center">
