                        ...
                        @if($resource->file_path && !$isUrlSource)
                            <div class="flex items-center justify-between p-3.5 bg-zinc-950 border border-zinc-800 rounded-xl">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-xs text-zinc-200 font-medium">{{ basename($resource->file_path) }}</p>
                                    </div>
                                </div>
                                <label for="file" class="px-3 py-1.5 text-xs font-medium text-zinc-300 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 rounded-lg cursor-pointer transition">
                                    Ganti File
                                </label>
                            </div>
                        @endif
