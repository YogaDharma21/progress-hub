        ...
        <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-sm">
            ...
            <div class="mt-5 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-3">
                    ...
                    <!-- Uploaded File Display / New Input File -->
                    <div id="source-file-container" class="space-y-1.5 pt-1 {{ $initialSourceType == 'video' ? 'hidden' : '' }}">
                        ...
                        <label for="file" class="relative flex flex-col items-center justify-center w-full h-36 border-2 border-dashed border-zinc-800 hover:border-zinc-700 bg-zinc-950 rounded-xl cursor-pointer transition overflow-hidden group">
                            @if($resource->file_path && !$isUrlSource)
                                <div id="file-selected-info" class="flex flex-col items-center justify-center p-4 text-center">
                                    ...
                                    <p id="file-name-display" class="text-xs font-semibold text-zinc-100 max-w-[200px] truncate">{{ basename($resource->file_path) }}</p>
                                    <p id="file-size-display" class="text-[10px] text-zinc-400 mt-0.5">File Tersimpan</p>
                                    <span class="mt-1 text-[10px] text-emerald-400 font-medium">Klik untuk ganti file</span>
                                </div>
                                <div id="file-placeholder" class="hidden flex flex-col items-center justify-center p-4 text-center">
