...
<div class="space-y-8 max-w-2xl mx-auto">
    ...
    <div>
        <h1 class="text-3xl font-bold text-zinc-100 tracking-tight">Edit Resource</h1>
        <p class="mt-1 text-sm text-zinc-400">Perbarui detail modul, artikel, atau tutorial.</p>
    </div>
        ...
        <form class="space-y-4" onsubmit="return false;">
            ...
            <div class="space-y-1.5">
                ...
                <textarea id="resource-desc" rows="4" 
                    class="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3.5 py-2.5 text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-400 transition">Panduan langkah demi langkah memahami komponen, props, state, dan lifecycle React</textarea>
            </div>
