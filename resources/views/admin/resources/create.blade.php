        ...
        <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-sm">
            ...
            <div class="mt-5 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <label for="resource-image" class="flex flex-col items-center justify-center w-full h-36 border-2 border-dashed border-zinc-800 hover:border-zinc-700 bg-zinc-950 rounded-xl cursor-pointer transition">
