...
function DownloadIllustration() {
    return (
        <div className="z-1 absolute inset-0 m-auto size-fit scale-95">
            <Button variant="secondary" className="bg-background/25 inset-ring inset-ring-foreground/25 ml-1 backdrop-blur" size="sm" render={<div />} nativeButton={false}><HardDriveDownload className="opacity-75" /><span className="border-r pr-2">Download</span><ChevronDown className="opacity-50" /></Button>
