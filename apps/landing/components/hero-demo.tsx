            ...
            <div className="bg-zinc-950 min-h-[300px] lg:min-h-[420px]">
                ...
                <div className="flex items-center justify-between px-4 lg:px-5 py-3 border-b border-zinc-800/60">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[9px] text-zinc-400 hidden sm:inline">Ahmad Fauzi</span>
                    </div>
                </div>
                    ...
                    <div className="mt-5 lg:mt-6">
                        <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-1.5">
                                ...
                                <span className="text-[11px] lg:text-xs font-semibold text-zinc-100">Portofolio & Proyek Mahasiswa</span>
                            </div>
                            <span className="text-[8px] lg:text-[9px] text-zinc-500 underline">Lihat Semua Proyek</span>
                        </div>
                        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-3 lg:p-4 max-w-sm">
                            <div className="w-full h-16 lg:h-20 bg-gradient-to-br from-violet-500/20 to-blue-500/20 rounded-lg border border-zinc-800 mb-2.5 flex items-center justify-center">
                    ...
                    <div className="mt-5 lg:mt-6">
                        <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-1.5">
                                ...
                                <span className="text-[11px] lg:text-xs font-semibold text-zinc-100">Repositori Pembelajaran & Artikel</span>
                            </div>
