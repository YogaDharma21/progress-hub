...
@section('title', 'Progress Hub — Submit Project')

@section('content')
<div class="space-y-8 max-w-4xl mx-auto">
    <form action="{{ route('members.submissions.projects.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-800 pb-6">
            <div>
                ...
                <h1 class="text-2xl font-bold text-zinc-100 tracking-tight">Submit Project Baru</h1>
                <p class="mt-1 text-xs text-zinc-400">Isi detail portofolio atau proyek. Akan dikirim ke admin untuk review.</p>
            </div>
        ...
        <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-sm">
            ...
            <div class="mt-5 space-y-5">
                <div class="space-y-1.5">
                    ...
                    <label for="image" class="relative flex flex-col items-center justify-center w-full h-56 border-2 border-dashed border-zinc-800 hover:border-zinc-700 bg-zinc-950 rounded-xl cursor-pointer transition overflow-hidden group">
                        <div id="image-placeholder" class="flex flex-col items-center justify-center py-10 text-center">
                        ...
                        <div id="image-preview-container" class="hidden absolute inset-0 w-full h-full">
                            ...
                            <div class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition flex items-center justify-center text-xs font-semibold text-white">Klik untuk ganti gambar</div>
                        </div>
            ...
            <div id="features-container" class="mt-5 grid grid-cols-1 md:grid-cols-2 gap-5">
                <div class="feature-item bg-zinc-950 border border-zinc-800 rounded-xl p-5 space-y-4 relative group hover:border-zinc-700 transition shadow-sm">
                    <div class="flex items-center justify-between pb-1">
                        <span class="feature-label inline-flex items-center px-3 py-1 rounded-md text-xs font-semibold bg-zinc-800 text-zinc-200 border border-zinc-700">Fitur 01</span>
        ...
        <div class="pt-4 flex items-center justify-between">
            <span class="text-xs text-zinc-400">Periksa kembali detail sebelum mengirim.</span>
            <div class="flex items-center gap-3">
                <a href="{{ route('members.dashboard') }}" class="px-4 py-2.5 text-xs font-semibold text-zinc-400 hover:text-zinc-100 transition">Batal</a>
